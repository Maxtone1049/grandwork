...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - Withdrawal History</title>
        <meta name="title" Content="Profit Ultimate - Withdrawal History">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Withdrawal History">
        <meta itemprop="name" content="Profit Ultimate - Withdrawal History">
        ...
        <meta property="og:url" content="withdrawal/history">
                ...
                <div class="row justify-content-center align-items-center ml-b-30">
                    <div class="col-lg-10 text-center mrb-30">
                        <div class="banner-content">
                            <h2 class="title">Withdrawal History</h2>
                        ...
                        <div class="col-lg-12 mrb-30">
                            <div class="order-table-area">
                                <table class="order-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="100%">You have made no withdrawals!</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
