...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - User Upgrade</title>
        <meta name="title" Content="Profit Ultimate - User Upgrade">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - User Upgrade">
        <meta itemprop="name" content="Profit Ultimate - User Upgrade">
        ...
        <meta property="og:url" content="upgrade">
    ...
    <body>
                ...
                <div class="row justify-content-center align-items-center ml-b-30">
                    <div class="col-lg-10 text-center mrb-30">
                        <div class="banner-content">
                            <h2 class="title">User Upgrade</h2>
        ...
        <section class="dashboard-section py-4">
            ...
            <?php include ('sidebar.php')?>
                <div class="container">
                    <h3 class="pb-3 mt-5 mb-3 font-italic text-center">Upgrade User Package
</h3>
                    <div class="row">
                        <div class="col-md-8 m-auto">
                            <div class="card mb-4 shadow-sm">
                                <div class="card-body">
                                    <h4 class="gray mb-3 p-3">Current Package: </h4>
                                    <form action="upgrade" method="POST">
                                        <input type="hidden" name="_token">
                                        <div class="form-row">
                                            <div class="form-group col-12">
                                                <label class="font-weight-bolder">Enter Upgrade Code</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control plan-price" name="upgrade" required>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <button type="submit" id="verifyBtn" class="cmn-btn btn-block">Upgrade</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
