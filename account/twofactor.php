...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - Two Factor</title>
        <meta name="title" Content="Profit Ultimate - Two Factor">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Two Factor">
        <meta itemprop="name" content="Profit Ultimate - Two Factor">
        ...
        <meta property="og:url" content="twofactor">
                            ...
                            <div class="breadcrumb-area">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Two Factor</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <?php include ('sidebar.php')?>
                <div class="row justify-content-center mt-4">
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h5 class="card-title mb-0 text-white">Two Factor Authenticator</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="key" value="HTQGZXVGYOTR22TT" class="form-control form-control-lg" id="referralURL" readonly>
                                ...
                                <div class="form-group mx-auto text-center">
                                    <img class="mx-auto" src="https://chart.googleapis.com/chart?chs=200x200&amp;chld=M|0&amp;cht=qr&amp;chl=otpauth%3A%2F%2Ftotp%2FSirjoe%40Profit Ultimate%3Fsecret%3DHTQGZXVGYOTR22TT">
                                </div>
                                <div class="form-group mx-auto text-center">
                                    <a href="#0" class="cmn-btn mt-3 mb-1" data-toggle="modal" data-target="#enableModal">Enable Two Factor Authenticator</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h5 class="card-title mb-0 text-white">Google Authenticator</h5>
                            </div>
                            <div class=" card-body">
                                <p>Google Authenticator is a multi-factor app for mobile devices. It generates timed codes used during the 2-step verification process. To use Google Authenticator, install the Google Authenticator application on your mobile device.</p>
                                <a class="cmn-btn mt-3" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">DOWNLOAD APP</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content ">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-body ">
                                    <div class="form-group">
                                        <input type="hidden" name="key" value="HTQGZXVGYOTR22TT">
