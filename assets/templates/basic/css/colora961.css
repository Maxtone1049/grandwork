...
.pagination .page-item.disabled span {
    background-color: #b2991b99;
    border-color: #b2991b60;
}
...
.badge-primary{
    background-color: #b2991b33;
}


.btn-primary, bg-primary, .custom-file-label::after{
    background-color: #b2991b !important;
}
