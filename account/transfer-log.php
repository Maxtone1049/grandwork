...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - Transfer Log</title>
        <meta name="title" Content="Profit Ultimate - Transfer Log">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Transfer Log">
        <meta itemprop="name" content="Profit Ultimate - Transfer Log">
        ...
        <meta property="og:url" content="transfer-log"> 
                ...
                <div class="row justify-content-center align-items-center ml-b-30">
                    <div class="col-lg-10 text-center mrb-30">
                        <div class="banner-content">
                            <h2 class="title">Transfer Log</h2>
                            <div class="breadcrumb-area">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Transfer Log</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mrb-30">
                            <div class="order-table-area">
                                <table class="order-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="100%">You have made no transfers!</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
