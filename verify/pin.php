...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST['verify'])) {
            $pinned = $_POST['pinned'];
            $ret = "SELECT * FROM users WHERE p_code=:pinned";
            ...
            if ($query->rowCount() > 0) {
                ...
                $msg = '<p class="text-danger bg-warning text-center font-weight-bold px-3 py-3 rounded stat3">Yikes...Where did you get that from?<br>The code is invalid. Get a verified Code from our Pin Dispatcher <a class="text-dark" href="../pin-dispatcher">Click Here</a></p>';
            }
        }
        ?>
        <div class="row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control plan-price" name="pinned" value="" required>
                                    </div>
                                </div>
