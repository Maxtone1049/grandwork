...
if (isset($_POST['action'])) {
    ...
    $via = "SELECT p_code from users where p_code=:purchase_code";
    $qui = $dbh->prepare($via);
...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Sign Up">
    <meta itemprop="name" content="Profit Ultimate - Sign Up">
                        ...
                        <form action="" method="POST" class="register-form">
                            ...
                            <div class="row justify-content-center ml-b-20">
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="E-Mail Address" name="email" value="" required>
                                </div>
                                <div class="col-lg-6 form-group">
                                ...
                                <div class="col-lg-12 form-group">
                                    <label class="register-icon"><i class="fas fa-code"></i></label>
                                    <input type="text" class="form-control" name="purchase_code" placeholder="Enter Purchase Code" value="" required>
                                </div>
                                <div class="col-lg-12 buysome">
                                    <a href="pin-dispatcher">No code? Click here to buy activation code</a>
                                </div>
                                <div class="col-lg-12 form-group text-center">
                                    <div class="checkbox-wrapper d-flex flex-wrap align-items-center">
                                        <div class="checkbox-item">
                                            ...
                                            <label for="c1">
                                                I agree with the <a class="text-primary" href="links/disclaimer-87">Disclaimer </a>, <a class="text-primary" href="links/cookie-policy-83">Cookie Policy </a>, <a class="text-primary" href="links/terms-of-service-78">Terms of Service </a>, <a class="text-primary" href="links/privacy-policy-77">Privacy Policy </a>
                                            </label>
                                        </div>
                                    </div>
                                </div>
