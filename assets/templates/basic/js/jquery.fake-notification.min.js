        ...
        var c = a.extend(
            {
				...
				Varible3: ["Deposited", "Invested", "Withdrawn"],
                Amount: [1000, 50000],
                Content: "[Varible1] from [Varible2] has just [Varible3] $[Amount].",
                Show: ["stable", 5, 25],
                Close: 5,
                Time: [0, 23],
                LocationTop: [true, "10%"],
        ...
        return this.each(function () {
            ...
            function B() {
                ...
                if (c.LocationTop[0] == true) {
                    if (c.LocationRight[0] == true) {
                        a(self).css({ top: c.LocationTop[1], right: c.LocationRight[1] });
                    } else {
                        a(self).css({ top: c.LocationTop[1], left: c.LocationLeft[1] });
                    }
                } else {
                    if (c.LocationRight[0] == true) {
                        a(self).css({ bottom: c.LocationTop[1], right: c.LocationRight[1] });
                    } else {
                        a(self).css({ bottom: c.LocationTop[1], left: c.LocationLeft[1] });
                    }
                }
            ...
            function A() {
                ...
                setTimeout(function () {
					...
					var rand_heard_action = Math.floor(Math.random() * c.Varible3.length);
					...
					if (content.indexOf("[Varible3]") + 1) {
                        var content = content.replace("[Varible3]", c.Varible3[rand_heard_action]);
                    } else {
                        var content = content.replace("[Varible3]", c.Varible3[rand_heard_action]);
                    }
