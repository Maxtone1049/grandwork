...
return true;
      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
         <div class="col-lg-5">
            <div>
              <h2>PROFIT-ELITE</h2>
              <p>Reset Your ADMIN Passowrd</p>
              <p>Please fill the following detail to reset the password.</p>

              <hr>
              <p>Already have an account| <br> <a href="login">Sign In</a></p>
            </div>
          </div>
          <div class="col-lg-7">
 ...
 <form class="form-auth-small" action="" method="post" name="chngpwd" onSubmit="return valid();">
       ...
       <p class="tx-center tx-white-5 tx-12 mg-t-15"> <script>
      document.write(new Date().getFullYear());
    </script> &copy; PROFIT-ELITE.ONLINE. All right Reversed</p>
      </div><!-- signin-box -->
