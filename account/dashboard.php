...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - Dashboard</title>
        <meta name="title" Content="Profit Ultimate - Dashboard">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Dashboard">
        <meta itemprop="name" content="Profit Ultimate - Dashboard">
                ...
                <div class="row justify-content-center ml-b-60">
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-code-fork la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Mine Amount</h3>
                                <h4 class="title">
                                    <span class="d-block"><?php echo $row->mine_amount?>PU</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-dollar la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Profit - Trend Amount</h3>
                                <h4 class="title">
                                    <span class="d-block">₦<?php echo $row->trend_amount?>.0</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-satellite la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Total Withdrawal</h3>
                                <h4 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-rocket la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Referral Amount</h3>
                                <h4 class="title">
                                    <span class="d-block">₦<?php echo $row->Ref_amount?>.00</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-share la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Profit - Trend Shares</h3>
                                <h4 class="title">
                                    <span class="d-block"><?php echo $row->trend_shares?></span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-fax la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">No. Of Referrals</h3>
                                <h4 class="title">
                                    <span class="d-block"><?php echo $row->refferals?></span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8 mrb-60">
                        <div class="dash-item d-flex flex-wrap">
                            <div class="dash-icon">
                                <i class="la la-cog la-4x"></i>
                            </div>
                            <div class="dash-content">
                                <h3 class="sub-title">Total Mine</h3>
                                <h4 class="title">
                                    <span class="d-block"><?php echo $row->total_mine?></span>
                                </h4>
                            </div>
                        </div>
                    </div>
