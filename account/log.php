...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Profit Ultimate - Trend Logs</title>
        <meta name="title" Content="Profit Ultimate - Trend Logs">
        ...
        <meta name="apple-mobile-web-app-title" content="Profit Ultimate - Trend Logs">
        <meta itemprop="name" content="Profit Ultimate - Trend Logs">
                            ...
                            <div class="breadcrumb-area">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Trend Logs</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <table class="order-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-label="Description">Trend Post</td>
                                            <td data-label="Balance">₦500</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
